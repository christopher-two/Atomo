...
/**
 * Use case to synchronize all user data (Profile, Menus, Portfolios, CVs, Shops, Invitations) in parallel.
 * This is typically called on app startup or manual refresh.
 */
