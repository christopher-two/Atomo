...
fun SettingsRoot(
    ...
    Scaffold(
        ...
        if (state.isLoading) {
            ...
            Column(
                ...
                SettingsSection(title = "Account") {
                    ...
                    Button(
                        onClick = { viewModel.onAction(SettingsAction.ShowDeleteAccountDialog(true)) },
        ...
        if (state.showDeleteAccountDialog) {
            AlertDialog(
                onDismissRequest = { viewModel.onAction(SettingsAction.ShowDeleteAccountDialog(false)) },
                title = { Text("¿Eliminar cuenta?") },
                text = { Text("Esta acción es irreversible. Se eliminará tu perfil, configuración, y todos tus datos. ¿Estás seguro de que deseas continuar?") },
                confirmButton = {
                    Button(
                        onClick = { 
                            viewModel.onAction(SettingsAction.ShowDeleteAccountDialog(false))
                ...
                dismissButton = {
                    TextButton(
                        onClick = { viewModel.onAction(SettingsAction.ShowDeleteAccountDialog(false)) }
                    ) {
                        Text("Cancelar")
                    }
                }
